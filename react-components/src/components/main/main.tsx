...
export class PageMain extends Component {
  ...
  componentWillUnmount() {
    localStorage.setItem('inputData', this.inputData);
  }

  getInputData(e: React.FormEvent<HTMLInputElement>) {
    this.inputData = e.currentTarget.value;
  }
      ...
      <div className="main__wrapper">
        <div className="search-cont">
          <input
            ...
            onChange={(evt) => this.getInputData(evt)}
          ></input>
